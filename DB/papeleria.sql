...
--
-- Servidor: localhost
-- Tiempo de generación: 01-08-2024 a las 07:07:58
...
(3, 'Ana', 'Lopez', 'Martínez', 'Calle2', '789', 'Colonia2', 34567, 'analopez@correo.com', '6666666666', 'ana', 2, 'password'),
...
--
ALTER TABLE `Proveedor`
  MODIFY `IDGerente` int(5) NOT NULL AUTO_INCREMENT;
